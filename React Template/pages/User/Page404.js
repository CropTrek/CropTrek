...
const Page404 = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", padding: "20px"}}>
      ...
      <h3 className="title" style={{marginBottom: "10px"}}>Your account is blocked :( </h3>
      <br></br>
      <br></br>
        <Button className="btn" color="warning" style={{marginRight: "10px"}} onClick={handleClick} >GO TO HOME </Button>
        <Button className="btn" color="warning" style={{marginRight: "10px"}} onClick={handleClickContact} >CONTACT ADMIN</Button>
